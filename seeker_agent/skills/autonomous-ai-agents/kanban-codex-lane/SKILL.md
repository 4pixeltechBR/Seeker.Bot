...
description: Use when a SeekerAgent Kanban worker wants to run Codex CLI as an isolated implementation lane while SeekerAgent keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Seeker Agent
license: MIT
metadata:
  seeker_agent:
    ...
    related_skills: [kanban-worker, codex, seeker_agent-agent]
---
