...
old_session_id=<old>). This lets plugin engines (e.g. seeker_agent-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See seeker_agent-lcm#68: after SeekerAgent compresses and mints a new physical session,
