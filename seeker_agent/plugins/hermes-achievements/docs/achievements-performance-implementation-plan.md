# SeekerAgent Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.seeker_agent/plugins/seeker_agent-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.seeker_agent/plugins/seeker_agent-achievements/scan_checkpoint.json`.
