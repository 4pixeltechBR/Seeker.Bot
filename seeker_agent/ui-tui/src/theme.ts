...
// Mirrors @seeker_agent/ink's colorize.ts. Keep local: app code compiles from
// ui-tui/src, while @seeker_agent/ink is bundled separately from packages/.
...
//
// Anything we can't decide stays dark — the default SeekerAgent palette
// is the dark one.
