...
as ``kind: backend``) or ``~/.seeker_agent/plugins/image_gen/<name>/`` (user, opt-in
via ``plugins.enabled``).
...
def _images_cache_dir() -> Path:
    """Return ``$SEEKER_HOME/cache/images/``, creating parents as needed."""
...
def save_b64_image(
    ...
    *,
    ...
    """Decode base64 image data and write it under ``$SEEKER_HOME/cache/images/``.
...
def save_url_image(
    ...
    *,
    ...
    """Download an image URL and write it under ``$SEEKER_HOME/cache/images/``.
