"""
Skills configuration for Seeker Agent.
`seeker_agent skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.seeker_agent/config.yaml under:
...
from seeker_cli.config import cfg_get, load_config, save_config
from seeker_cli.colors import Colors, color
from seeker_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `seeker_agent skills`."""
    from seeker_cli.curses_ui import curses_checklist
