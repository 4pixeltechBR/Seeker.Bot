...
def _profile_user_agent() -> str:
    """Return a ``seeker_agent-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from seeker_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"seeker_agent-cli/{_ver}"
    except Exception:
        return "seeker_agent-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # seeker_agent-cli UA so the catalog endpoint is reachable.
