...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateHermes: "Atualizar SeekerAgent",
    updatingHermes: "A atualizar SeekerAgent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins SeekerAgent (paridade com `seeker_agent plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.seeker_agent/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.seeker_agent/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.seeker_agent/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do SeekerAgent obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do SeekerAgent. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o SeekerAgent",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o SeekerAgent detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O SeekerAgent analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
