#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the SeekerAgent docs site.
...
Both publish at:
  https://seeker_agent-agent.nousresearch.com/docs/llms.txt
  https://seeker_agent-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://seeker_agent-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use SeekerAgent as a Python Library", None),
        ("guides/use-mcp-with-seeker_agent", "Use MCP with SeekerAgent", None),
        ("guides/use-voice-mode-with-seeker_agent", "Use Voice Mode with SeekerAgent", None),
        ("guides/use-soul-with-seeker_agent", "Use SOUL.md with SeekerAgent", None),
        ("guides/build-a-seeker_agent-plugin", "Build a SeekerAgent Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with SeekerAgent"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "seeker_agent-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/seeker_agent-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Seeker Agent — Full Documentation\n",
        (
            "This file is the entire Seeker Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using SeekerAgent, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://seeker_agent-agent.nousresearch.com/docs\n",
        "Short index: https://seeker_agent-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
