...
在环境中设置 Tenor API 密钥（添加到 `~/.seeker_agent/.env`）：
...
- GIF URL 可直接用于 markdown：`![alt](https://github.com/NousResearch/seeker_agent-agent/blob/main/skills/media/gif-search/url)`