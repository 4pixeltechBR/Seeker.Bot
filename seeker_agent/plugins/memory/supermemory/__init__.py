...
_DEFAULT_CONTAINER_TAG = "seeker_agent"
...
class SupermemoryMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        # Only prompt for the API key during `seeker_agent memory setup`.
        # All other options are documented for $SEEKER_HOME/supermemory.json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._seeker_home = kwargs.get("hermes_home") or str(get_hermes_home())
        self._session_id = session_id
        self._turn_count = 0
        self._config = _load_supermemory_config(self._seeker_home)
    ...
    def sync_turn(self, user_content: str, assistant_content: str, *, session_id: str = "") -> None:
        ...
        metadata = {"source": "seeker_agent", "type": "conversation_turn"}
