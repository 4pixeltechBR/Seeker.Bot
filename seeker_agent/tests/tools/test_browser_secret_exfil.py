...
class TestBrowserSecretExfil:
    ...
    def test_allows_normal_url(self):
        ...
        mock_result = {"success": True, "data": {"title": "ok", "url": "https://github.com/NousResearch/seeker_agent-agent"}}
        with patch("tools.browser_tool._run_browser_command", return_value=mock_result), \
            ...
            result = browser_navigate("https://github.com/NousResearch/seeker_agent-agent")
        parsed = json.loads(result)
