...
Control the user's Spotify account via the SeekerAgent Spotify toolset (7 tools). Setup guide: https://seeker_agent-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `seeker_agent auth spotify` again.
