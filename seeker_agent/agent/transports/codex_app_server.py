...
projection into SeekerAgent' display, approval bridging, transcript projection into
...
"codex_app_server"`. SeekerAgent' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
        ...
        if spawn_env.get("HERMES_KANBAN_TASK"):
            ...
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "HERMES_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("SEEKER_HOME", os.path.expanduser("~/.seeker_agent")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "seeker_agent",
        client_title: str = "Seeker Agent",
