...
from seeker_cli.proxy.adapters.base import UpstreamAdapter
from seeker_cli.proxy.adapters.nous_portal import NousPortalAdapter
from seeker_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``seeker_agent proxy start --provider <name>`` CLI flag.
