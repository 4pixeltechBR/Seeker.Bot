...
# seeker_agent modules.  seeker_cli sets HERMES_PYTHON_SRC_ROOT before spawning this
...
# ``seeker_agent --tui``) imports cleanly there.  SIGBREAK (Windows' Ctrl+Break)
...
def main():
    ...
    # server stalled the whole shell on "summoning seeker_agent…" for the full
