...
One ``CDPSupervisor`` runs per SeekerAgent ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "seeker_agent-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://seeker_agent-dialog-bridge.invalid/";
