...
| | |
|---|---|
| Source | Optional — install with `seeker_agent skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Seeker Agent |
| License | MIT |
...
import upstream classes into SeekerAgent itself.
...
```bash
mkdir -p ~/.seeker_agent/cache/darwinian-evolver && cd ~/.seeker_agent/cache/darwinian-evolver
...
```bash
cd ~/.seeker_agent/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.seeker_agent/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.seeker_agent/skills/research/darwinian-evolver
DE_DIR=~/.seeker_agent/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside SeekerAgent core.
   Custom driver scripts under `~/.seeker_agent/skills/...` are user-side and fine.
