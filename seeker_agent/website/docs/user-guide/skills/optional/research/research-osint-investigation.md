...
| | |
|---|---|
| Source | Optional — install with `seeker_agent skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Seeker Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $HERMES_OSINT_CACHE/icij/ (default: ~/.cache/seeker_agent-osint/icij/).
