#!/usr/bin/env python3
"""Build the SeekerAgent Skills Index — a centralized JSON catalog of all skills.
...
`seeker_agent skills search/install` can use it without hitting the GitHub API.
...
# Ensure SEEKER_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building SeekerAgent Skills Index...", flush=True)
