...
session-scoped state file under ``$SEEKER_HOME/workspace/meetings/.active.json``
...
# File + directory layout (under $SEEKER_HOME):
#
#   workspace/meetings/
...
def start(
    ...
    *,
    ...
    If a bot is already running for this seeker_agent install, leave it first —
