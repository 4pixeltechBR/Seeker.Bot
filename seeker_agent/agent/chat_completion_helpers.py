...
from seeker_cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
from seeker_constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
...
def build_api_kwargs(agent, api_messages: list) -> dict:
    ...
    if _is_qwen:
        _qwen_meta = {
            "sessionId": agent.session_id or "seeker_agent",
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        if not fb_api_key_hint:
            ...
            # _normalize_custom_provider_entry in seeker_cli/config.py).
...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    ...
    try:
        ...
        for msg in messages:
            ...
            # and every SeekerAgent-internal underscore-prefixed scaffolding key.
