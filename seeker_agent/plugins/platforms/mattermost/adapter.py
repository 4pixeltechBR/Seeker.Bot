...
required — uses aiohttp which is already a SeekerAgent dependency.
...
def interactive_setup() -> None:
    ...
    ``seeker_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where SeekerAgent delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # seeker_cli/setup.py::_setup_mattermost function.
