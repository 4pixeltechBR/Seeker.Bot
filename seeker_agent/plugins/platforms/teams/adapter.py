"""
Microsoft Teams platform adapter for Seeker Agent.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "SeekerAgent"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"SeekerAgent\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
    ...
    print()
    print_success("Teams configuration saved to ~/.seeker_agent/.env")
