...
# regardless of approval level (e.g. logout kills the session SeekerAgent runs in).
_BLOCKED_KEY_COMBOS = {
...
def handle_computer_use(args: Dict[str, Any], **kwargs) -> Any:
    ...
    try:
        ...
        return json.dumps({
            ...
            "hint": "Run `seeker_agent tools` and enable Computer Use to install cua-driver.",
        })
...
def _route_capture_through_aux_vision(
    ...
    The captured base64 PNG is materialised to ``$SEEKER_HOME/cache/vision/``
