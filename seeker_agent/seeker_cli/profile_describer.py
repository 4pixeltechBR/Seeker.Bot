...
Used by ``seeker_agent profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``seeker_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Seeker Agent kanban board.
...
Rules:
  ...
  - Never write "Seeker Agent profile" or other meta-narration.
