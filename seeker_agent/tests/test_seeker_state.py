"""Tests for seeker_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSessionLifecycle:
    ...
    def test_db_initializes_without_fts5_module(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("seeker_state.sqlite3.connect", connect_without_fts)
...
class TestSchemaInit:
    ...
    def test_schema_version(self, db):
        from seeker_state import SCHEMA_VERSION
    ...
    def test_topic_mode_schema_is_not_auto_migrated_on_open(self, tmp_path):
        ...
        The gateway must remain rollback-safe: simply upgrading SeekerAgent and starting
    ...
    def test_schema_sql_is_source_of_truth(self, db):
        ...
        """
        from seeker_state import SCHEMA_SQL
...
class TestConcurrentWriteSafety:
    ...
    def test_sqlite_timeout_is_at_least_30s(self, db):
        ...
        import inspect
        from seeker_state import SessionDB as _SessionDB
