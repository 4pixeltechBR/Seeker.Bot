...
**Autonomous cognitive agent for Telegram with persistent memory, computer vision, and 17 modular skills.**
...
Seeker.Bot is not a chatbot — it's an **autonomous cognitive agent** that lives in your Telegram. It decides how to think about each message (reflexive, deliberate, or deep analysis), searches the web, remembers everything you've discussed, and runs 17 independent skills in the background — from daily news curation to sales prospecting.
...
|---|---|---|
| **Seeker Sales** | Unified BDR — B2B prospecting + event mining | — |
| **Event Map Scout** | Predictive regional event mapping with PDF reports | — |
| **Seeker Sales Week** | Weekly sales report with lead dossiers | SMTP |
