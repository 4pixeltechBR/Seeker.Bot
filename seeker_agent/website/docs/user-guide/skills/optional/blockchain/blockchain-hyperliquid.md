...
| | |
|---|---|
| Source | Optional — install with `seeker_agent skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Seeker Agent |
| License | MIT |
...
The script reads `~/.seeker_agent/.env` for two optional defaults:
...
Helper script: `~/.seeker_agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.seeker_agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.seeker_agent/.env`.
...
```bash
python3 ~/.seeker_agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.seeker_agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
