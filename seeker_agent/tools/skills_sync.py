...
Copies bundled skills from the repo's skills/ directory into ~/.seeker_agent/skills/
...
The manifest lives at ~/.seeker_agent/skills/.bundled_manifest.
"""
...
from seeker_constants import get_bundled_skills_dir, get_hermes_home, get_optional_skills_dir
...
def _compute_relative_dest(skill_dir: Path, bundled_dir: Path) -> Path:
    ...
    e.g., bundled/skills/mlops/axolotl -> ~/.seeker_agent/skills/mlops/axolotl
    """
...
def sync_skills(quiet: bool = False) -> dict:
    """
    Sync bundled skills into ~/.seeker_agent/skills/ using the manifest.
                ...
                if dest.exists():
                    ...
                    if _dir_hash(dest) == bundled_hash:
                        ...
                        print(
                            ...
                            f"was kept. Run `seeker_agent skills reset {skill_name}` "
...
def reset_bundled_skill(name: str, restore: bool = False) -> dict:
    ...
    if not in_manifest and not is_bundled:
        return {
            ...
            "message": (
                ...
                f"(Hub-installed skills use `seeker_agent skills uninstall`.)"
            ),
            "synced": None,
        }
    ...
    if restore and deleted_user_copy:
        ...
        message = (
            f"Cleared manifest entry for '{name}'. Future `seeker_agent update` runs "
...
if __name__ == "__main__":
    print("Syncing bundled skills into ~/.seeker_agent/skills/ ...")
