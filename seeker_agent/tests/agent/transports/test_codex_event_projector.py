"""Tests for CodexEventProjector — codex item/* events → SeekerAgent messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks SeekerAgent' message alternation invariant."""
