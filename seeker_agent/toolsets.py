...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `seeker_agent tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "video_gen": {
        "description": (
            ...
            "``seeker_agent tools`` → Video Generation."
        ),
    ...
    # ==========================================================================
    # Full SeekerAgent toolsets (CLI + messaging platforms)
    #
    ...
    "seeker_agent-cron": {
        # Mirrors seeker_agent-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `seeker_agent tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as seeker_agent-cli; gated by `seeker_agent tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },

    "seeker_agent-telegram": {
        "description": "Telegram bot toolset - full access for personal use (terminal has safety checks)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    
    "seeker_agent-discord": {
    ...
    "seeker_agent-bluebubbles": {
        "description": "BlueBubbles iMessage bot toolset - Apple iMessage via local BlueBubbles server",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },

    "seeker_agent-homeassistant": {
    ...
    "seeker_agent-email": {
        "description": "Email bot toolset - interact with SeekerAgent via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },

    "seeker_agent-mattermost": {
    ...
    "seeker_agent-wecom-callback": {
        "description": "WeCom callback toolset - enterprise self-built app messaging (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },

    "seeker_agent-yuanbao": {
    ...
    "seeker_agent-sms": {
        "description": "SMS bot toolset - interact with SeekerAgent via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "seeker_agent-gateway": {
        ...
        "tools": [],
        "includes": ["seeker_agent-telegram", "seeker_agent-discord", "seeker_agent-whatsapp", "seeker_agent-slack", "seeker_agent-signal", "seeker_agent-bluebubbles", "seeker_agent-homeassistant", "seeker_agent-email", "seeker_agent-sms", "seeker_agent-mattermost", "seeker_agent-matrix", "seeker_agent-dingtalk", "seeker_agent-feishu", "seeker_agent-wecom", "seeker_agent-wecom-callback", "seeker_agent-weixin", "seeker_agent-qqbot", "seeker_agent-webhook", "seeker_agent-yuanbao"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (seeker_agent-<name>).
        # Gives them _HERMES_CORE_TOOLS plus any tools the plugin registered
        # into a toolset matching the platform name.
        if name.startswith("seeker_agent-"):
            platform_name = name[len("seeker_agent-"):]
            try:
