...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/NousResearch/seeker_agent-agent/issues/23994:
    reply_to_mode 'off' was ignored when sending via SeekerAgent-created DM topic
