...
Built for [Seeker Agent](https://github.com/NousResearch/seeker_agent-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/seeker_agent-agent/skills/creative/ascii-video`](https://github.com/NousResearch/seeker_agent-agent/tree/main/skills/creative/ascii-video) via PR.
