#!/usr/bin/env python3
"""Build the SeekerAgent Model Catalog — a centralized JSON manifest of curated models.
...
Seeker CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a SeekerAgent release.
...
# Ensure SEEKER_HOME is set for imports that touch it at module level.
os.environ.setdefault("SEEKER_HOME", os.path.join(os.path.expanduser("~"), ".seeker_agent"))

from seeker_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "seeker_agent-agent repo",
            "docs": "https://seeker_agent-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
