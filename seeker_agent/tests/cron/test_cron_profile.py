...
SEEKER_HOME scoping, and tick() serialization for profile jobs.
"""
...
def isolated_cron_profile_home(tmp_path, monkeypatch):
    """Create an isolated SeekerAgent root with a named profile and temp cron store."""
    root = tmp_path / "seeker_agent-root"
...
class TestCronjobToolProfile:
    ...
    def test_schema_advertises_profile(self):
        ...
        assert "seeker_agent profile" in desc_lower
...
class TestRunJobProfileContext:
    ...
    def _install_agent_stubs(monkeypatch, observed: dict):
        ...
        class FakeAgent:
            def __init__(self, **kwargs):
                ...
                observed["env_home_during_init"] = os.environ.get("SEEKER_HOME")
            ...
            def run_conversation(self, *_a, **_kw):
                ...
                observed["env_home_during_run"] = os.environ.get("SEEKER_HOME")
        ...
        from seeker_cli import runtime_provider as runtime_provider
        ...
        monkeypatch.setattr(sched, "_seeker_home", None)
    ...
    def test_run_job_sets_and_restores_profile_home(
        ...
        assert os.environ["SEEKER_HOME"] == str(root)
    ...
    def test_no_agent_profile_uses_profile_scripts_dir_and_restores_env(
        ...
        (scripts_dir / "print_home.py").write_text(
            "import os\nprint(os.environ.get('SEEKER_HOME', ''))\n",
            encoding="utf-8",
        )
        monkeypatch.setattr(sched, "_seeker_home", None)
