...
Trust levels:
  - builtin:   Ships with SeekerAgent. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.seeker_agent/\.env|\~/\.seeker_agent/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references SeekerAgent secrets file"),
    ...
    (r'\.seeker_agent/config\.yaml|\.seeker_agent/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references SeekerAgent configuration files directly"),
