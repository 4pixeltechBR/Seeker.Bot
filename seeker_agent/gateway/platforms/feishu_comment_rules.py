...
Config: ~/.seeker_agent/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.seeker_agent/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (SEEKER_HOME-aware and
