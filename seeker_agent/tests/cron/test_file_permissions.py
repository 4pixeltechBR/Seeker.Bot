...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("seeker_cli.config.get_config_path", return_value=config_path), \
             patch("seeker_cli.config.ensure_hermes_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("seeker_cli.config.get_env_path", return_value=env_path), \
             patch("seeker_cli.config.ensure_hermes_home"):
    ...
    def test_ensure_hermes_home_sets_0700(self):
        home = Path(self.tmpdir) / ".seeker_agent"
        with patch("seeker_cli.config.get_hermes_home", return_value=home):
