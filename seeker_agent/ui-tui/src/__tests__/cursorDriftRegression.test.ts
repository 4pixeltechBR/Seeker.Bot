 ...
 *
 * Symptom: in `seeker_agent --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@seeker_agent/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using seeker_agent --tui and as i type multiline my caret at the end will often ' +
