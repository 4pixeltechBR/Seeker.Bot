---
sidebar_position: 8
title: "Use Voice Mode with SeekerAgent"
description: "A practical guide to setting up and using SeekerAgent voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with SeekerAgent
...
- you want SeekerAgent sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in SeekerAgent.
...
## Step 1: make sure normal SeekerAgent works first
...
SeekerAgent supports both local and cloud speech stacks.
...
4. SeekerAgent transcribes and responds
...
- asking SeekerAgent to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full SeekerAgent loop.

## Tuning CLI behavior

### Silence threshold

If SeekerAgent starts/stops too aggressively, tune:
...
SeekerAgent stays a normal chat bot, but can speak replies.
...
- you want SeekerAgent to function like a portable research or ops assistant
...
SeekerAgent joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- SeekerAgent detects speech boundaries
- transcripts are posted in the associated text channel
- SeekerAgent responds in text and audio
...
1. get text SeekerAgent working
2. install `seeker_agent-agent[voice]`
