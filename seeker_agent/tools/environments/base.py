"""Base class for all SeekerAgent execution environment backends.
...
def get_sandbox_dir() -> Path:
    ...
    Configurable via TERMINAL_SANDBOX_DIR. Defaults to {SEEKER_HOME}/sandboxes/.
    """
...
class BaseEnvironment(ABC):
    """Common interface and unified execution flow for all SeekerAgent backends.
    ...
    def __init__(self, cwd: str, timeout: int, env: dict = None):
        ...
        self._snapshot_path = f"{temp_dir}/seeker_agent-snap-{self._session_id}.sh"
        self._cwd_file = f"{temp_dir}/seeker_agent-cwd-{self._session_id}.txt"
    ...
    def init_session(self):
        ...
        # caused ``C:/Users/.../seeker_agent-snap-*.sh: No such file or directory``
