    ...
    async def _migrate_schema(self) -> None:
        ...
        try:
            ...
            migrations = [
                ...
                ("intent_signals_evidence", "ALTER TABLE scout_leads ADD COLUMN intent_signals_evidence TEXT"),
                ("budget_indicator", "ALTER TABLE scout_leads ADD COLUMN budget_indicator TEXT"),
                ("company_description", "ALTER TABLE scout_leads ADD COLUMN company_description TEXT"),
                ("company_size", "ALTER TABLE scout_leads ADD COLUMN company_size TEXT"),
                ("company_revenue_range", "ALTER TABLE scout_leads ADD COLUMN company_revenue_range TEXT"),
                ("tech_stack", "ALTER TABLE scout_leads ADD COLUMN tech_stack TEXT"),
                ("identified_pain_points", "ALTER TABLE scout_leads ADD COLUMN identified_pain_points TEXT"),
                ("current_solution", "ALTER TABLE scout_leads ADD COLUMN current_solution TEXT"),
                ("competitive_landscape", "ALTER TABLE scout_leads ADD COLUMN competitive_landscape TEXT"),
                ("decision_makers", "ALTER TABLE scout_leads ADD COLUMN decision_makers TEXT"),
                ("account_research_cache_ttl", "ALTER TABLE scout_leads ADD COLUMN account_research_cache_ttl INTEGER DEFAULT 168"),
                ("account_research_source", "ALTER TABLE scout_leads ADD COLUMN account_research_source TEXT"),
