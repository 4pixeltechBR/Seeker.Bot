# SeekerAgent Achievements Performance Spec (Post-Hackathon)

Status: Draft (no code changes yet)
Owner: seeker_agent-achievements plugin
...
### `GET /api/plugins/seeker_agent-achievements/achievements`
...
### `POST /api/plugins/seeker_agent-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/seeker_agent-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/seeker_agent-achievements/overview`
...
- Persist plugin data under:
  - `~/.seeker_agent/plugins/seeker_agent-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.seeker_agent/plugins/seeker_agent-achievements/scan_checkpoint.json`
...
- `~/.seeker_agent/plugins/seeker_agent-achievements/`
