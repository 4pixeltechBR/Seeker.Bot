...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update SeekerAgent",
    updatingHermes: "Updating SeekerAgent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update SeekerAgent plugins (`seeker_agent plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.seeker_agent/plugins/?",
    removeHint: "Only user-installed plugins under ~/.seeker_agent/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.seeker_agent/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible SeekerAgent badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning SeekerAgent session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run SeekerAgent more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once SeekerAgent sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "SeekerAgent is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
