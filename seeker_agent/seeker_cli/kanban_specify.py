...
Used by ``seeker_agent kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``seeker_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Seeker Agent board.
...
def _profile_author() -> str:
    """Mirror of ``seeker_cli.kanban._profile_author``. Kept local to
