"""Lightweight internationalization (i18n) for SeekerAgent static user-facing messages.

Scope (thin slice, by design): only the highest-impact static strings shown
to the user by SeekerAgent itself -- approval prompts, a handful of gateway slash
...
def _load_catalog(lang: str) -> dict[str, str]:
    ...
    try:
        import yaml  # PyYAML is already a seeker_agent dependency
...
def reset_language_cache() -> None:
    ...
    Call after :func:`seeker_cli.config.save_config` if a running process
