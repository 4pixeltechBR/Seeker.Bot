...
describe('forceTruecolor', () => {
  ...
  it('respects existing FORCE_COLOR unless SeekerAgent truecolor is explicit', async () => {
    await withCleanEnv(
      () => {
  ...
  it('lets explicit SeekerAgent truecolor override existing FORCE_COLOR', async () => {
    await withCleanEnv(
      () => {
