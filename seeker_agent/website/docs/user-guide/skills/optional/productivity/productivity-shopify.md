...
| | |
|---|---|
| Source | Optional — install with `seeker_agent skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"SeekerAgent","productType":"Apparel","tags":["test"]}}'
```
