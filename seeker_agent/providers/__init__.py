...
1. Bundled plugins: ``plugins/model-providers/<name>/`` (shipped with seeker_agent-agent)
2. User plugins: ``$SEEKER_HOME/plugins/model-providers/<name>/``
...
def register_provider(profile: ProviderProfile) -> None:
    ...
    plugins under ``$SEEKER_HOME/plugins/model-providers/`` can override
...
def _user_plugins_dir() -> Path | None:
    """Return ``$SEEKER_HOME/plugins/model-providers/`` if it exists."""
    try:
...
def _import_plugin_dir(plugin_dir: Path, source: str) -> None:
    ...
    # multiple SEEKER_HOME profiles don't alias each other.
...
def _discover_providers() -> None:
    ...
    Order:
      ...
      2. User plugins at ``$SEEKER_HOME/plugins/model-providers/<name>/``
    ...
    # 1. Bundled plugins — shipped with seeker_agent-agent.
    ...
    # 2. User plugins — under $SEEKER_HOME/plugins/model-providers/<name>/.
