...
```python
import sys
sys.path.insert(0, "/home/teknium/.seeker_agent/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.seeker_agent/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — SeekerAgent installs package this)
