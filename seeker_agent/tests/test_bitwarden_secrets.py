...
binary download are exercised manually by `seeker_agent secrets bitwarden
...
def hermes_home(tmp_path, monkeypatch):
    """Point SeekerAgent at an isolated home directory."""
    ...
    if hasattr(seeker_constants, "_HERMES_HOME_CACHE"):
        seeker_constants._HERMES_HOME_CACHE = None  # type: ignore[attr-defined]
    return home
...
def test_env_loader_skips_when_disabled(tmp_path, monkeypatch):
    ...
    from seeker_cli.env_loader import _apply_external_secret_sources
