...
`mcp_tool.py`, and `seeker_cli/mcp_config.py`. This module is the ONLY place
...
class MCPOAuthManager:
    ...
    def remove(self, server_name: str) -> None:
        ...
        Called by ``seeker_agent mcp remove <name>`` and (indirectly) by
        ``seeker_agent mcp login <name>`` during forced re-auth.
        """
        with self._entries_lock:
