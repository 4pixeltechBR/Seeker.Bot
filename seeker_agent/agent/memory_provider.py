...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - hermes_home (str): The active SEEKER_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.seeker_agent``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "seeker_agent").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'seeker_agent memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], hermes_home: str) -> None:
        ...
        Called by 'seeker_agent memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``hermes_home`` is the active SEEKER_HOME directory path.
