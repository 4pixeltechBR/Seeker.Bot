...
from seeker_constants import get_hermes_dir as _get_hermes_dir
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        if self._encryption:
            ...
            try:
                ...
                _acct_id = self._user_id or "seeker_agent"
    ...
    def _strip_mention(self, body: str) -> str:
        ...
        otherwise normal phrases like "Seeker Agent" become "Agent".
        """
        if not body:
            return ""
