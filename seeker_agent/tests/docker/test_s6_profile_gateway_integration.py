...
The unit tests in tests/seeker_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned seeker_agent-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/seeker_agent")
from seeker_cli.service_manager import S6ServiceManager
