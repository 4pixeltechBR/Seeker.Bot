...
Verifies that:
 ...
 2. User plugins at $SEEKER_HOME/plugins/model-providers/<name>/ override bundled
...
def test_user_plugin_overrides_bundled(tmp_path, monkeypatch):
    ...
    # Point SEEKER_HOME at a fresh temp dir
...
def test_general_plugin_manager_skips_model_provider_kind(tmp_path, monkeypatch):
    ...
    from seeker_cli import plugins as plugin_mod
