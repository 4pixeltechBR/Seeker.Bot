...
```bash
python3 -m pyfiglet "seeker_agent" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=seeker_agent&font=Slant" | boxes -d stone
```
