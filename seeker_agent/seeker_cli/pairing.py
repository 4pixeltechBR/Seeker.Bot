...
Usage:
    seeker_agent pairing list              # Show all pending + approved users
    seeker_agent pairing approve <platform> <code>  # Approve a pairing code
    seeker_agent pairing revoke <platform> <user_id> # Revoke user access
    seeker_agent pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle seeker_agent pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: seeker_agent pairing {list|approve|revoke|clear-pending}")
        print("Run 'seeker_agent pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.seeker_agent/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'seeker_agent pairing list' to see pending codes.\n")
