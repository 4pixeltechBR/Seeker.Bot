#!/bin/bash
# ============================================================================
# Seeker Agent Setup Script
# ============================================================================
# Quick setup for developers who cloned the repo manually.
# Uses uv for desktop/server setup and Python's stdlib venv + pip on Termux.
#
# Usage:
#   ./setup-seeker_agent.sh
#
# This script:
...
# 5. Symlinks the 'seeker_agent' CLI command into a user-facing bin dir
...
echo ""
echo -e "${CYAN}⚕ Seeker Agent Setup${NC}"
echo ""
...
if is_termux; then
    ...
    if [ -n "$UV_CMD" ]; then
        ...
        _uv_log="$(mktemp 2>/dev/null || echo "/tmp/seeker_agent-uv-install.$$.log")"
...
# ============================================================================
# PATH setup — symlink seeker_agent into a user-facing bin dir
# ============================================================================

echo -e "${CYAN}→${NC} Setting up seeker_agent command..."

HERMES_BIN="$SCRIPT_DIR/venv/bin/seeker_agent"
COMMAND_LINK_DIR="$(get_command_link_dir)"
COMMAND_LINK_DISPLAY_DIR="$(get_command_link_display_dir)"
mkdir -p "$COMMAND_LINK_DIR"
ln -sf "$HERMES_BIN" "$COMMAND_LINK_DIR/seeker_agent"
echo -e "${GREEN}✓${NC} Symlinked seeker_agent → $COMMAND_LINK_DISPLAY_DIR/seeker_agent"
...
# ============================================================================
# Seed bundled skills into ~/.seeker_agent/skills/
# ============================================================================

HERMES_SKILLS_DIR="${SEEKER_HOME:-$HOME/.seeker_agent}/skills"
mkdir -p "$HERMES_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.seeker_agent/skills/ ..."
...
echo "Other commands:"
echo "  seeker_agent status        # Check configuration"
if is_termux; then
    echo "  seeker_agent gateway       # Run gateway in foreground"
else
    echo "  seeker_agent gateway install # Install gateway service (messaging + cron)"
fi
echo "  seeker_agent cron list     # View scheduled jobs"
echo "  seeker_agent doctor        # Diagnose issues"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]] || [[ -z $REPLY ]]; then
    ...
    "$SCRIPT_DIR/venv/bin/python" -m seeker_cli.main setup
fi
