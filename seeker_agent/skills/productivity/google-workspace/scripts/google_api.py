#!/usr/bin/env python3
"""Google Workspace API CLI for Seeker Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing SeekerAgent-facing JSON contract and falls back to the Python client
...
from _seeker_home import get_hermes_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Seeker Agent")
