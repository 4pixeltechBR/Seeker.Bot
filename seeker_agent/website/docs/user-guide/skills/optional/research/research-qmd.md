...
| | |
|---|---|
| Source | Optional — install with `seeker_agent skills install official/research/qmd` |
...
Seeker Agent via the native MCP client. This is the preferred
...
Then configure Seeker Agent to connect via HTTP:
