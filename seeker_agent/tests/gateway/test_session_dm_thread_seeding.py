...
def store(tmp_path, monkeypatch):
    ...
    ~/.seeker_agent/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at seeker_state import time, before pytest's SEEKER_HOME monkeypatch
    fires — the autouse fixture's SEEKER_HOME override doesn't help here.)
    """
    import seeker_state
