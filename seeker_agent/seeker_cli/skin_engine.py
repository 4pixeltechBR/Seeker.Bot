"""Seeker CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.seeker_agent/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Seeker Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ SeekerAgent "       # Response box header label
...
.. code-block:: python
    ...
    from seeker_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Seeker Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.seeker_agent/skins/
...
Drop a YAML file in ``~/.seeker_agent/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic SeekerAgent — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Seeker Agent",
            "welcome": "Welcome to Seeker Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ SeekerAgent ",
            "prompt_symbol": "❯",
