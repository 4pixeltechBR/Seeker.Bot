# SeekerAgent Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.seeker_agent/plugins/seeker_agent-achievements/state.json` (existing unlock state)
  - `~/.seeker_agent/plugins/seeker_agent-achievements/scan_snapshot.json` (new)
  - `~/.seeker_agent/plugins/seeker_agent-achievements/scan_checkpoint.json` (new)
