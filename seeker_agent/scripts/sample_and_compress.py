...
DEFAULT_DATASETS = [
    ...
    "NousResearch/seeker_agent-agent-megascience-sft1",
    "NousResearch/SeekerAgent-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/SeekerAgent-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-seeker_agent-agent"
]
