...
Invoked by ``seeker_agent kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Seeker Agent board.
...
def _profile_author() -> str:
    """Mirror of ``seeker_cli.kanban._profile_author``."""
    return (
