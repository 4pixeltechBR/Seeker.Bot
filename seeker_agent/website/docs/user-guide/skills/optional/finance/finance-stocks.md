...
| | |
|---|---|
| Source | Optional — install with `seeker_agent skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Seeker Agent |
| License | MIT |
...
```
SCRIPT=~/.seeker_agent/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.seeker_agent/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
