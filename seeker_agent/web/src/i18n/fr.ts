...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateHermes: "Mettre à jour SeekerAgent",
    updatingHermes: "Mise à jour de SeekerAgent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins SeekerAgent (parité avec `seeker_agent plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.seeker_agent/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.seeker_agent/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.seeker_agent/skills/",
  ...
  config: {
    configPath: "~/.seeker_agent/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  achievements: {
    hero: {
      ...
      title: "SeekerAgent Achievements",
      subtitle:
        "Badges SeekerAgent à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions SeekerAgent en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez SeekerAgent davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'SeekerAgent détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "SeekerAgent analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Seeker Agent ☤",
    },
  },
  kanban: {
