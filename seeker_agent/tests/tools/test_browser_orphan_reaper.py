...
def _make_socket_dir(tmpdir, session_name, pid=None, owner_pid=None):
    ...
    Args:
        ...
        owner_pid: owning seeker_agent PID to write to <session>.owner_pid
...
class TestOwnerPidCrossProcess:
    ...
    The owner_pid file records which seeker_agent process owns a daemon so that
    concurrent seeker_agent processes don't reap each other's active browser
