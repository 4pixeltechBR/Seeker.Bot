...
- User wants **SeekerAgent itself to drive a browser** → use SeekerAgent' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
