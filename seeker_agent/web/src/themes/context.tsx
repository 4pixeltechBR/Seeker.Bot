...
const STORAGE_KEY = "seeker_agent-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `seeker_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "seeker_agent-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-seeker_agent-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-seeker_agent-theme-font", "true");
