...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^SeekerAgent\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "seeker_agent@nousresearch.com",
    "seeker_agent-audit@example.com",
    "seeker_agent@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/seeker_agent-agent",
                "--state", "merged",
