...
| | |
|---|---|
| Source | Optional — install with `seeker_agent skills install official/health/neuroskill-bci` |
...
Connect SeekerAgent to a running [NeuroSkill](https://neuroskill.com/) instance to read
