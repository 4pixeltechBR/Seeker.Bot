#!/usr/bin/env python3
"""
SWE Runner with SeekerAgent Trajectory Format

A runner that uses SeekerAgent-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the SeekerAgent-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses SeekerAgent-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in SeekerAgent format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches SeekerAgent-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using SeekerAgent-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with SeekerAgent Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses SeekerAgent-Agent's built-in execution environments
    and outputs trajectories in SeekerAgent-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to SeekerAgent trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to SeekerAgent trajectory format
...
def main(
    ...
    """
    Run SWE tasks with SeekerAgent trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with SeekerAgent Trajectory Format")
    print("=" * 60)
