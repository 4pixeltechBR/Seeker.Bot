...
//
// Both gate on HERMES_DEV_PERF=1 and dump JSON-lines (default ~/.seeker_agent/perf.log,
...
import { scrollFastPathStats } from '@seeker_agent/ink'
...
const LOG_PATH = process.env.HERMES_DEV_PERF_LOG?.trim() || join(homedir(), '.seeker_agent', 'perf.log')
